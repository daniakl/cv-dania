...
export function Header({ lang }: { lang: "en" | "fr" }) {
  return (
    <Tooltip.Provider delay={200}>
      <div className="sticky top-0 w-screen z-50 text-zinc-900">
        <ProgressiveBlurBG />

        <div className="md:pt-8 pt-4 pb-4">
          <div className="relative z-10 bg-violet-50/80 overflow-clip border border-zinc-200 backdrop-blur-lg p-1.5 rounded-full shadow-lg shadow-purple-800/10 flex items-center justify-between max-w-xl max-sm:mx-3 mx-auto">
